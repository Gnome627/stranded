...
IMPULSES:BindKey1( "GS_GAME", "KEY_3",		"IM_CAR_FIRE_ALL" )
...
IMPULSES:BindKey1( "GS_GAME", "KEY_SPACE",			"IM_CAR_HAND_BREAK" )
...
IMPULSES:BindKey1( "GS_GAME", "KEY_F5",			"IM_QUICK_SAVE" )
IMPULSES:BindKey1( "GS_GAME", "KEY_F9",			"IM_QUICK_LOAD" )
